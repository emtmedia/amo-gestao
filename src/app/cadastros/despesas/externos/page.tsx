...
const emptyForm = { fornecedorId:'', servicoPrestadoId:'', dataVencimento:'', valorTitulo:'', dataPagamento:'', contaBancariaId:'', metodoTransferenciaId:'', projetoDirecionado:'', eventoDirecionado:'', observacoes:'', arquivosReferencia: '' }
...
export default function Page() {
  ...
  const handleSave = async () => {
    if (!form.fornecedorId || !form.servicoPrestadoId || !form.valorTitulo || !form.dataPagamento || !form.metodoTransferenciaId) { showToast('Preencha todos os campos obrigatórios','error'); return }
    setSaving(true)
    try {
